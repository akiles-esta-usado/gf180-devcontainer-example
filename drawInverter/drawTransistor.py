...
def drawTransistor(
    ...
    if nf >= 2:
        ...
        sourceMOS_H = gf.components.rectangle(
    ...
    if nf >= 3:
        ...
        drainMOS_H = gf.components.rectangle(
            size=(Length_horizontal_metal1_conection, width_metal1_conection),
            layer=metal_s,
        )  # 3.72
    ...
    # poly conect
    poly_down = gf.components.rectangle(
    ...
    bulk_plus_left = gf.components.rectangle(
    ...
    if typeTransistor == "Pmos":
        bulk_nwell_left = gf.components.rectangle(
    ...
    bulk_comp_right = gf.components.rectangle(
        size=(0.37, w_gate_folding), layer="comp"
    ...
    bulk_m1_right = gf.components.rectangle(
        size=(0.36, w_gate_folding - 2 * 0.08), layer="metal1"
    ...
    bulk_plus_right = gf.components.rectangle(
        size=(0.59 + 0.27, w_gate_folding + 2 * 0.23), layer=bulk_plus
    )  # agregando el bulk del lado derecho   0.87-0.28=0.59
    ...
    if typeTransistor == "Pmos":
        bulk_nwell_right = gf.components.rectangle(
            size=(0.59 + 0.27, w_gate_folding + 2 * 0.43), layer="nwell"
        )
    ...
    bulk_m1_left_conect = gf.components.rectangle(
    ...
    bulk_m1_right_conect = gf.components.rectangle(
